...
namespace Hertzole.CecilAttributes.Editor
{
    public static partial class Weaver
    {
        private static readonly BaseProcessor[] processors = new BaseProcessor[]
        {
            ...
            //new OnChangeProcessor(),
            new GetComponentProcessor()
        };

        public static Dictionary<FieldDefinition, MethodDefinition> replacementSetters = new Dictionary<FieldDefinition, MethodDefinition>();
        public static Dictionary<FieldDefinition, MethodDefinition> replacementGetters = new Dictionary<FieldDefinition, MethodDefinition>();
